...
public class BasicSqlite extends AppCompatActivity {
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if(value.length()!=0){
                    ...
                    txtAdd.setText("");
                    Toast.makeText( BasicSqlite.this,"Add Succesfully!" , Toast.LENGTH_LONG).show();
//                    //render
                    UserAdaper adapter = new UserAdaper(BasicSqlite.this
                            , R.layout.activity_item_list,  renderData(db));
                    listView.setAdapter(adapter);
                }
                else{
                    Toast.makeText( BasicSqlite.this,"Add faild!" , Toast.LENGTH_LONG).show();
                }
            }
        });
